...
import { AI_MODEL_CONFIGS, AIModelType, XIAOMI_MIMO_MODEL_ID, XIAOMI_TOKEN_PLAN_ENDPOINT } from "@/config/ai";
...
export const useAIConfigStore = create<AIConfigState>()(
  persist(
    (set, get) => ({
      ...
      deepseekModelId: "",
      openaiApiKey: "",
      openaiModelId: XIAOMI_MIMO_MODEL_ID,
      openaiApiEndpoint: XIAOMI_TOKEN_PLAN_ENDPOINT,
      geminiApiKey: "",
