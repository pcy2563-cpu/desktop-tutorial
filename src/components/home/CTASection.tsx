...
export default function CTASection() {
  ...
  return (
    <section className="qx-cta-section py-24 md:py-44 relative overflow-hidden">
        ...
        <AnimatedFeature>
          <div className="flex flex-col items-center">
            ...
            <GoDashboard>
              <Button 
                size="lg" 
                className="qx-primary-cta rounded-2xl h-16 px-12 text-xl font-medium shadow-2xl shadow-primary/30 hover:shadow-primary/40 active:scale-95 transition-all group"
              >
                {t("cta.button")}
