...
export default function FeaturesSection() {
  ...
  return (
    <section className="qx-section-surface py-16 md:py-28 overflow-hidden">
      <div className="container mx-auto px-6 max-w-6xl">
        ...
        <div className="space-y-20 md:space-y-28">
          {features.map((category, catIndex) => (
            <div 
              key={catIndex} 
              className={`flex flex-col gap-8 md:gap-12 lg:gap-20 items-center ${
                catIndex % 2 === 1 ? "lg:flex-row-reverse" : "lg:flex-row"
              }`}
            >
              {/* Text Side */}
              <div className="w-full lg:w-5/12 space-y-7 md:space-y-10">
                ...
                <div className="space-y-4">
                  {category.items.map((item, itemIndex) => (
                    <button
                      ...
                      data-active={activeFeatures[catIndex] === itemIndex ? "true" : "false"}
                      className={`qx-feature-tab w-full text-left group p-5 rounded-2xl transition-all relative border overflow-hidden ${
              ...
              <div className="w-full lg:w-7/12">
                <AnimatedFeature key={`${catIndex}-${activeFeatures[catIndex]}`} delay={0.2}>
                  <div className="qx-feature-preview relative aspect-[16/10] min-h-[220px] bg-secondary/20 rounded-3xl border border-border/50 p-6 sm:p-10 shadow-2xl backdrop-blur-sm group overflow-hidden">
